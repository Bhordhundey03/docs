...
<Info>
  New to bulk transfer? Read the [overview](/api-reference/bulk-transfers/overview) first — it explains statuses, reprocessing, and idempotency, all of which apply to this endpoint. Prefer working from a spreadsheet instead of building the JSON payload yourself? See [Upload via Excel](/api-reference/bulk-transfers/upload).
</Info>
